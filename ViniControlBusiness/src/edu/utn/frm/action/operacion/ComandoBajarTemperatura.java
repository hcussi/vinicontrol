 ...
 * @author Proyecto
 */
public class ComandoBajarTemperatura extends Comando implements IComandoTanque{

    private static final int ID_COMANDO = 1;

    public ComandoBajarTemperatura(ConfiguracionConexion configuracionConexion, Proceso proceso){
    ...
    protected int getComandoID() {
        ...
        return (cs!=null&&cs.getIdComandoBajarTemperatura()!=null)?cs.getIdComandoBajarTemperatura(): ID_COMANDO;
    }
