 ...
 * @author Proyecto
 */
public class ComandoRemontaje extends Comando implements IComandoTanque{

    private static final int ID_COMANDO = 2;

    public ComandoRemontaje(ConfiguracionConexion configuracionConexion, Proceso proceso){
    ...
    protected int getComandoID() {
        ...
        return (cs!=null && cs.getIdComandoRemontaje()!=null)?cs.getIdComandoRemontaje(): ID_COMANDO;
    }
