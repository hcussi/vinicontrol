/*
 * ConexionIPIFrame.java
 *
 * Created on 04/08/2009, 17:09:11
 */
package edu.utn.frm.ui.comunicacion;

import edu.utn.frm.action.comunicacion.ConexionIPAbm;
 ...
 * @author Proyecto
 */
public class ConexionIPIFrame extends javax.swing.JInternalFrame {

    private GenericTableModel<ConexionIP> model = new GenericTableModel<ConexionIP>(
            new String[]{"Código", "Descripción", "Estado", "Dirección IP", "Puerto", "Puerto Recepción"},
            new String[]{"codigo", "descripcion", "estado", "direccionIPv4", "puerto", "puertoRecepcion"});
    private ConexionIPAbm gestorAbm = new ConexionIPAbm();
    private GenericComboBoxModel<TipoConexion> modelTipoConexion =
            new GenericComboBoxModel(buscarTodosTipoConexion(), "descripcion");

    /** Creates new form ConexionIPIFrame */
    public ConexionIPIFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tipoConexionComboBox = new javax.swing.JComboBox();
        probarConexionButton = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        puertoRecepcionText = new javax.swing.JTextField();
        probarConexionRecepcionButton = new javax.swing.JButton();
        ...
        buscarIpText = new javax.swing.JTextField();
        ...
        datosPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Conexión IP"));
        ...
        ipText.setName("txtTCapacidad"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${entity.detalle}"), ipText, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        jLabel4.setText("Puerto Recepción:");
        ...
        puertoText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        puertoText.setName("txtTDescripcion"); // NOI18N
        ...
        tipoConexionComboBox.setModel(modelTipoConexion);
        tipoConexionComboBox.setName("tipoConexionComboBox"); // NOI18N

        probarConexionButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/utn/frm/ui/resources/image/probar.png"))); // NOI18N
        probarConexionButton.setText("Probar Conexión");
        probarConexionButton.setName("probarConexionButton"); // NOI18N
        probarConexionButton.addActionListener(new java.awt.event.ActionListener() {

            public void actionPerformed(java.awt.event.ActionEvent evt) {
                probarConexionButtonActionPerformed(evt);
            }
        });
        ...
        puertoRecepcionText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        puertoRecepcionText.setName("puertoRecepcionText"); // NOI18N

        probarConexionRecepcionButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/utn/frm/ui/resources/image/probar.png"))); // NOI18N
        probarConexionRecepcionButton.setText("Probar Conexión");
        probarConexionRecepcionButton.setName("probarConexionRecepcionButton"); // NOI18N
        probarConexionRecepcionButton.addActionListener(new java.awt.event.ActionListener() {

            public void actionPerformed(java.awt.event.ActionEvent evt) {
                probarConexionRecepcionButtonActionPerformed(evt);
            }
        });
        ...
        datosPanel1Layout.setHorizontalGroup(
                datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addGap(17, 17, 17).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel3).addComponent(jLabel2).addComponent(jLabel6).addComponent(jLabel4).addComponent(jLabel8)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(descripcionText).addComponent(codigoText, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE).addComponent(ipText)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addComponent(jLabel7).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(estadoCheckBox).addGap(90, 90, 90).addComponent(limpiarDatosEntityButton, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)).addComponent(tipoConexionComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))).addGroup(datosPanel1Layout.createSequentialGroup().addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(puertoRecepcionText, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(puertoText, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(probarConexionButton).addComponent(probarConexionRecepcionButton)))).addContainerGap()));
        datosPanel1Layout.setVerticalGroup(
                datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addContainerGap().addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel7).addComponent(codigoText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel2).addComponent(limpiarDatosEntityButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(estadoCheckBox)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel3).addComponent(descripcionText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(tipoConexionComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(ipText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel6)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(probarConexionButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(puertoText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel8)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(probarConexionRecepcionButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(puertoRecepcionText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel4)).addContainerGap()));
        ...
        buscarIpText.setName("buscarIpText"); // NOI18N
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        ...
        gestorAbm.getFilter().setIp(buscarIpText.getText());
        model.setRows(gestorAbm.buscar());
    ...
    private void probarConexionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_probarConexionButtonActionPerformed
        if (modelTipoConexion.getSelectedEntity().equals(TipoConexion.UDP)) {
            try {
                boolean usado = GestorGeneralEstado.getInstance().isConfiguracionConexionUsada(getEntity());
                if( usado ){
                    JOptionPane.showMessageDialog(datosDialog, "La configuración esta sienda usado en el control de " +
                            "procesos, no se puede modificar.", "Información", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                gestorAbm.probarConexionUDP();
                JOptionPane.showMessageDialog(datosDialog, "La conexión ha sido exitosa", "Probando Conexión", JOptionPane.INFORMATION_MESSAGE);
            } catch (ComunicacionException ex) {
                JOptionPane.showMessageDialog(datosDialog, ex.getMessage(), "La prueba ha fallado", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(datosDialog, "Sólo se puede probar la conexión para UDP", "Probando Conexión", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_probarConexionButtonActionPerformed

    private void probarConexionRecepcionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_probarConexionRecepcionButtonActionPerformed
        if (modelTipoConexion.getSelectedEntity().equals(TipoConexion.UDP)) {
            try {
                boolean usado = GestorGeneralEstado.getInstance().isConfiguracionConexionUsada(getEntity());
                if( usado ){
                    JOptionPane.showMessageDialog(datosDialog, "la conexión esta siendo usada en el control de " +
                            "procesos, no se puede modificar.", "Información", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                gestorAbm.probarConexionRecepcionUDP();
                JOptionPane.showMessageDialog(datosDialog, "La conexión ha sido exitosa", "Probando Conexión", JOptionPane.INFORMATION_MESSAGE);
            } catch (ComunicacionException ex) {
                JOptionPane.showMessageDialog(datosDialog, ex.getMessage(), "La prueba ha fallado", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private javax.swing.JButton probarConexionButton;
    private javax.swing.JButton probarConexionRecepcionButton;
    private javax.swing.JTextField puertoRecepcionText;
    private javax.swing.JTextField puertoText;
    private javax.swing.JScrollPane sPanel;
    private javax.swing.JButton salirButton;
    private javax.swing.JComboBox tipoConexionComboBox;
    ...
    private void guardar() {
        ...
        try {
            new Integer(puertoText.getText());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(datosDialog, "El puerto tiene un formato incorrecto.", "Error de validación", JOptionPane.ERROR_MESSAGE);
            return;
        }

        try {
            new Integer(puertoRecepcionText.getText());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(datosDialog, "El puerto de recepción tiene un formato incorrecto.", "Error de validación", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (!Utiles.verificarIp(ipText.getText())) {
            JOptionPane.showMessageDialog(datosDialog, "El formato de la dirección Ip es incorrecto.", "Error de validación", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void eliminar() {
        ConexionIP conexionIP = null;

        try {
            if (buscarTabla.getSelectedRow() != -1) {
                conexionIP = model.getRow(buscarTabla.getSelectedRow());
                if (conexionIP != null) {
                    ...
                    if (respuesta == JOptionPane.OK_OPTION) {
                        gestorAbm.setEntity(conexionIP);
                        gestorAbm.eliminar();
                        reset();
                        showDatosDialog(false);
                    }
    ...
    public void bindinDataEntity(int fuente) {
        if (fuente == servidor) {
            ...
            ipText.setText(getEntity().getDireccionIPv4());
            estadoCheckBox.setSelected(getEntity().getActiva());
            descripcionText.setText(getEntity().getDescripcion());
            puertoText.setText(Integer.toString(getEntity().getPuerto()));
            puertoRecepcionText.setText(Integer.toString(getEntity().getPuertoRecepcion()));
            modelTipoConexion.setSelectedEntity(getEntity().getTipoConexion());
        } else if (fuente == cliente) {
            getEntity().setCodigo(codigoText.getText());
            getEntity().setDireccionIPv4(ipText.getText());
            getEntity().setDescripcion(descripcionText.getText());
            getEntity().setActiva(estadoCheckBox.isSelected());
            getEntity().setPuerto(new Integer(puertoText.getText()));
            getEntity().setPuertoRecepcion(new Integer(puertoRecepcionText.getText()));
            getEntity().setTipoConexion(modelTipoConexion.getSelectedEntity());
        }

    }

    private List<TipoConexion> buscarTodosTipoConexion() {

        return Arrays.asList(TipoConexion.values());
    }
}
