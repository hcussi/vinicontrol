...
import edu.utn.frm.action.producto.FincaAbm;
 ...
 * @author Proyecto
 */
public class FincaIFrame extends javax.swing.JInternalFrame {

    private GenericTableModel<Finca> model = new GenericTableModel<Finca>(
            new String[]{"Código", "Descripción", "Razón Social", "Cantidad de Hectáreas"},
            new String[]{"codigo", "descripcion", "razonSocial", "cantidadHectareas"});
    private FincaAbm gestorAbm = new FincaAbm();
    ...
    private void initComponents() {
        ...
        copiarButton1 = new javax.swing.JButton();
        ...
        datosPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Finca"));
        ...
        cantidadText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        cantidadText.setName("txtTCapacidad"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${entity.detalle}"), cantidadText, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        razonSocialText.setName("txtTModelo"); // NOI18N

        direccionText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        direccionText.setName("txtTDescripcion"); // NOI18N
        ...
        sPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Fincas"));
        ...
        copiarButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/utn/frm/ui/resources/image/copiar.png"))); // NOI18N
        copiarButton1.setText("Copiar");
        copiarButton1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        copiarButton1.setName("copiarButton1"); // NOI18N
        copiarButton1.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void copiarButton1(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copiarButton1
        copiar();
    }//GEN-LAST:event_copiarButton1
    ...
    private javax.swing.JButton copiarButton1;
    ...
    private void editar() {
        ...
        if (buscarTabla.getSelectedRow() != -1) {
            finca = model.getRow(buscarTabla.getSelectedRow());
            if (finca != null) {
                gestorAbm.setEntity(finca);
                bindinDataEntity(servidor);
                habilitarPanelDatos(true);
                showDatosDialog(true);
            }
        ...
        if (finca == null) {
            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un Finca para editar");
        }
    }
    ...
    private void copiar() {
        ...
        if (finca == null) {
            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar una Finca para copiar");
        }
    }
    ...
    private void guardar() {
        ...
        try {
            new Integer(cantidadText.getText());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(datosDialog, "La cantidad tiene un formato incorrecto.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            if (buscarTabla.getSelectedRow() != -1) {
                ...
                if (finca != null) {
                    ...
                    int respuesta = JOptionPane.showConfirmDialog(datosDialog, "Está seguro que desea eliminar la Finca seleccionado?",
            ...
            if (finca == null) {
                JOptionPane.showInternalMessageDialog(this, "Debe seleccionar una Finca para eliminar");
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    ...
    public void bindinDataEntity(int fuente) {
        if (fuente == servidor) {
            ...
            cantidadText.setText(Integer.toString(getEntity().getCantidadHectareas()));
            ...
            getEntity().setCantidadHectareas(Integer.valueOf(cantidadText.getText()));
