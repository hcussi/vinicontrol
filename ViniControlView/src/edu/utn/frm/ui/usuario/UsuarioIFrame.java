...
import edu.utn.frm.action.usuario.UsuarioAbm;
...
public class UsuarioIFrame extends javax.swing.JInternalFrame {
    ...
    private GenericTableModel<Usuario> model = new GenericTableModel<Usuario>(
            new String[]{"Usuario", "DNI", "Apellido", "Nombre"}, new String[]{"usuario", "dni", "apellido", "nombre"});
    private UsuarioAbm gestorAbm = new UsuarioAbm();
    private RolModel rolModel;

    /** Creates new form UsuarioIFrame */
    ...
    private void initComponents() {
        ...
        tablaRoles = tablaRoles = new TableRecorder();
        ;
        ...
        buscarUsuarioText = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        buscarButton = new javax.swing.JButton();
        limpiarBuscadorButton = new javax.swing.JButton();
        nuevoButton = new javax.swing.JButton();
        editarButton = new javax.swing.JButton();
        buscarApellidoText = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        buscarDniText = new javax.swing.JTextField();
        ...
        datosDialog.setMinimumSize(new java.awt.Dimension(480, 470));
        ...
        datosPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Usuario"));
        ...
        usuarioText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        usuarioText.setName("txtTPatente"); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${entity.codigo}"), usuarioText, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        sPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Roles"));
        sPanel1.setName("sPanel1"); // NOI18N
        sPanel1.setPreferredSize(new java.awt.Dimension(420, 427));

        tablaRoles.setAutoCreateRowSorter(true);
        tablaRoles.setModel(model);
        tablaRoles.setName("tablaRoles"); // NOI18N
        tablaRoles.setDefaultRenderer(JComponent.class, new JComponentCellRenderer());
        tablaRoles.setDefaultEditor(JComponent.class, new JComponentCellEditor());
        sPanel1.setViewportView(tablaRoles);
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(420, 130));
        ...
        dniText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        dniText.setName("dniText"); // NOI18N

        telefonoText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        telefonoText.setName("telefonoText"); // NOI18N
        ...
        localidadText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        localidadText.setName("localidadText"); // NOI18N
        ...
        domicilioText.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        domicilioText.setName("domicilioText"); // NOI18N

        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGap(14, 14, 14).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel12, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel11, javax.swing.GroupLayout.Alignment.TRAILING)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(localidadText, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE).addComponent(dniText, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE).addComponent(nombreText, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel8, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel10, javax.swing.GroupLayout.Alignment.TRAILING)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(apellidoText, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE).addComponent(telefonoText, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE))).addComponent(domicilioText, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)).addGap(130, 130, 130)).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jLabel7).addGap(436, 436, 436)).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addContainerGap(29, Short.MAX_VALUE).addComponent(jLabel9).addGap(436, 436, 436)));
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel7).addComponent(nombreText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel8).addComponent(apellidoText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel9).addComponent(dniText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(telefonoText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel10)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(localidadText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel11)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 7, Short.MAX_VALUE).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(domicilioText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel12))));
        ...
        datosPanel1Layout.setHorizontalGroup(
                datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addGap(10, 10, 10).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel4).addComponent(jLabel3).addComponent(jLabel2)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(passwordConfirmField, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(passwordField, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 81, Short.MAX_VALUE).addComponent(limpiarDatosEntityButton, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, datosPanel1Layout.createSequentialGroup().addContainerGap(115, Short.MAX_VALUE).addComponent(usuarioText, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE).addGap(180, 180, 180)).addGroup(datosPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addContainerGap().addComponent(sPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))));
        datosPanel1Layout.setVerticalGroup(
                datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(datosPanel1Layout.createSequentialGroup().addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(usuarioText, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel2)).addGap(8, 8, 8).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(passwordField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel3)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel4).addComponent(passwordConfirmField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))).addComponent(limpiarDatosEntityButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(1, 1, 1).addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(151, Short.MAX_VALUE)).addGroup(datosPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, datosPanel1Layout.createSequentialGroup().addContainerGap(208, Short.MAX_VALUE).addComponent(sPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))));
        ...
        buscarUsuarioText.setName("buscarUsuarioText"); // NOI18N
        ...
        buscarApellidoText.setName("buscarApellidoText"); // NOI18N

        jLabel5.setText("Usuario");
        jLabel5.setName("jLabel5"); // NOI18N

        buscarDniText.setName("buscarDniText"); // NOI18N
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        gestorAbm.getFilter().setUsuario(buscarUsuarioText.getText());
        gestorAbm.getFilter().setApellido(buscarApellidoText.getText());
        gestorAbm.getFilter().setDni(buscarDniText.getText());
        model.setRows(gestorAbm.buscar());
    ...
    private void limpiarBuscadorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_limpiarBuscadorButtonActionPerformed
        buscarUsuarioText.setText("");
        buscarApellidoText.setText("");
        buscarDniText.setText("");
    ...
    private javax.swing.JTextField buscarApellidoText;
    private javax.swing.JButton buscarButton;
    private javax.swing.JTextField buscarDniText;
    private javax.swing.JTable buscarTabla;
    private javax.swing.JTextField buscarUsuarioText;
    ...
    private void editar() {
        ...
        if (buscarTabla.getSelectedRow() != -1) {
            usuario = model.getRow(buscarTabla.getSelectedRow());
            if (usuario != null) {
                gestorAbm.setEntity(usuario);
                bindinDataEntity(servidor);
                habilitarPanelDatos(true);
                showDatosDialog(true);
            }
        ...
        if (usuario == null) {
            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un Usuario para editar");
        }
    }
    ...
    private void copiar() {
        ...
        if (buscarTabla.getSelectedRow() != -1) {
            ...
            if (usuario != null) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Cambia el password del usuario nuevo. Por defecto es '123456'", "Información", JOptionPane.INFORMATION_MESSAGE);
                } catch (Exception ex) {
        ...
        if (usuario == null) {
            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un Usuario para copiar");
        }
    }
    ...
    private void guardar() {
        ...
        if (passwordField.getPassword().length == 0) {
            JOptionPane.showMessageDialog(datosDialog, "El password no puede estar vacío", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (!Arrays.equals(passwordField.getPassword(), passwordConfirmField.getPassword())) {
            JOptionPane.showMessageDialog(datosDialog, "El password y la confirmación del password deben ser iguales", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            if (buscarTabla.getSelectedRow() != -1) {
                ...
                if (usuario != null) {
                    ...
                    int respuesta = JOptionPane.showConfirmDialog(datosDialog, "Está seguro que desea eliminar el Usuario seleccionado?",
    ...
    public UsuarioAbm getGestorAbm() {
        return gestorAbm;
    }

    public void setGestorAbm(UsuarioAbm gestorAbm) {
    ...
    private void habilitarPanelDatos(boolean habilitar) {
        usuarioText.setEnabled(habilitar);
        passwordField.setEnabled(habilitar);
        passwordConfirmField.setEnabled(habilitar);
        nombreText.setEnabled(habilitar);
        apellidoText.setEnabled(habilitar);
        dniText.setEnabled(habilitar);
        telefonoText.setEnabled(habilitar);
        localidadText.setEnabled(habilitar);
        domicilioText.setEnabled(habilitar);
    ...
    public void bindinDataEntity(int fuente) {
        if (fuente == servidor) {
            usuarioText.setText(getEntity().getUsuario());
            nombreText.setText(getEntity().getNombre());
            apellidoText.setText(getEntity().getApellido());
            dniText.setText(getEntity().getDni());
            telefonoText.setText(getEntity().getTelefono());
            localidadText.setText(getEntity().getLocalidad());
            domicilioText.setText(getEntity().getDomicilio());
            rolModel = new RolModel(buscarTodosRoles(), true);
            tablaRoles.setModel(rolModel);
        } else if (fuente == cliente) {
            getEntity().setUsuario(usuarioText.getText());
            getEntity().setPassword(String.valueOf(passwordField.getPassword()));
            getEntity().setNombre(nombreText.getText());
            getEntity().setApellido(apellidoText.getText());
            getEntity().setDni(dniText.getText());
            getEntity().setTelefono(telefonoText.getText());
            getEntity().setLocalidad(telefonoText.getText());
            getEntity().setDomicilio(domicilioText.getText());
            getEntity().setRoles(rolModel.getSeleccionados());
        }
    }

    public List<Rol> buscarTodosRoles() {
        List<Rol> roles = gestorAbm.buscarTodosRoles();

        for (Rol rol : roles) {
            rol.setSeleccionado(false);
        }

        for (Rol rol : getEntity().getRoles()) {
            int index = roles.indexOf(rol);
            if (index >= 0) {
                Rol rolItem = (Rol) roles.get(index);
                rolItem.setSeleccionado(true);
            }
        }
